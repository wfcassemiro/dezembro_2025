...
if ($_SERVER['REQUEST_METHOD'] === 'POST' || isset($_GET['page'])) {
    ...
    if (!empty($level)) $total_selections++;
...
/* BARRA DE RELEVÂNCIA HORIZONTAL NO TOPO */
.relevance-bar-horizontal {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
.relevance-fill[data-level="very-low"] {
    background: linear-gradient(to right, #3498db, #5dade2);
}

.relevance-fill[data-level="low"] {
    background: linear-gradient(to right, #1abc9c, #48c9b0);
}

.relevance-fill[data-level="medium"] {
    background: linear-gradient(to right, #2ecc71, #58d68d);
}

.relevance-fill[data-level="high"] {
    background: linear-gradient(to right, #f39c12, #f8c471);
}

.relevance-fill[data-level="very-high"] {
...
<div class="main-content">
    ...
    <div class="guided-questions fade-item">
        ...
        <div class="question-item">
            <strong>3.</strong> Quais temas interessam você? (IA, CAT Tools, Carreira, Negócios...)
        </div>
        <div class="question-item">
            ...
            <div class="video-grid video-grid-four">
                ...
                ?>
                    <div class="video-card" onclick="location.href='/palestra.php?id=<?php echo $lecture['id']; ?>'">
                        <!-- Barra de Relevância Horizontal no Topo -->
                        <div class="relevance-bar-horizontal">
