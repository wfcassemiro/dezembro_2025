...
<div class="main-content">
    ...
    <div class="video-card profile-header-card" style="background: linear-gradient(135deg, var(--brand-purple), #4a148c); border: none; margin-bottom: 24px; height: auto; display: flex; flex-direction: row; align-items: center; justify-content: space-between; padding: 25px 30px; margin-top: 80px; margin-left: 5px; position: relative; z-index: 1;">
        ...
        <div style="display: flex; align-items: center;">
            <div class="header-icon-container" style="background: rgba(255, 255, 255, 0.1); border-radius: 50%; width: 60px; height: 60px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                <i class="fas fa-file-invoice-dollar" style="font-size: 24px; color: #fff;"></i>
            </div>
            <div class="header-text-container" style="margin-left: 20px;">
                <h2 style="margin: 0 0 5px 0; padding: 0; font-size: 1.5rem; color: #fff; font-weight: 600; border: none;">Orçamentos — Análise de Fuzzy Matches</h2>
                <p style="margin: 0; color: rgba(255, 255, 255, 0.8); font-size: 1rem;">Fluxo guiado para geração de orçamentos profissionais</p>
            </div>
        </div>
    </div>

    <div class="report-nav-buttons" style="display: flex; gap: 10px; align-items: center;">
