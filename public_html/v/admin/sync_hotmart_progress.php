...
define('HOTMART_API_BASE_URL', 'https://developers.hotmart.com'); // <-- CORREÇÃO APLICADA AQUI
...
try {
    ...
    $certificates_created = 0; $users_processed_this_run = 0;
    ...
    $message = "Sincronização concluída! Novos certificados criados nesta execução: {$certificates_created}.";
